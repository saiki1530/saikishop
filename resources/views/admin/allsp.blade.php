                                    ...
                                    <tbody>
                                        @foreach ($sanpham as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ trim(substr($product->ten_sp, 0, 10)) }}
                                                </td>
                                                <td>
                                                    <center>
                                                        @if ($product->hinh)
                                                            <img src="{{ asset($product->hinh) }}" alt="{{ $product->hinh }}" width="100" height="100">
                                                        @endif
                                                    </center>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    {{ number_format($product->gia_km) }}đ
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/editss', $product->id_sp) }}"><i class="bi bi-pen" style="font-size: 23px"></i></a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/xoa', $product->id_sp) }}"><i class="bi bi-trash" style="font-size: 23px"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
